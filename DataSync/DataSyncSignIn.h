...
/**
 The 'SignInDelegate' protocol is adopted by an object that manages the OpenID Connect authorization process.
 */
...
@interface DataSyncSignIn : NSObject
...
/**
 The  Data Service URL endpoint
 Must be set for DataObject fetch/save/delete to work.
 */
...
/**
 Returns a shared DataSyncSignIn instance.
 
 @return The DataSyncSignIn shared instance
 */
...
/**
 ...
 'DataSyncSignIn' handled this URL.
