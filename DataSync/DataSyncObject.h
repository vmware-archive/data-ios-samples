...
@interface DataSyncObject : NSObject

#pragma mark Constructors
///---------------------------
/// @name Creating a DataObject
///---------------------------

/**
 Creates a new DataObject with a class name.
...
/**
 Creates a new DataObject with a class name, initialized with data constructed from the specified set of objects and keys.
 @param className The object's class.
 @param dictionary An NSDictionary of keys and objects to set on the new DataObject.
 @result A DataObject with the given class name and set with the given data.
 */
+ (instancetype)objectWithClassName:(NSString *)className dictionary:(NSDictionary *)dictionary;

/**
 Initializes a new DataObject with a class name.
...
/**
 Sets the objects and keys from the dictionary on the DataObject at once
...
/**
 * For myObject[key] = value type syntx myDataObject[key].
 @param key The key.
 */
- (id)objectForKeyedSubscript:(NSString *)key;

/**
 * For myDataObject[key] = value type syntx
 @param object The object.
 @param key The key.
 */
...
/**
 Saves the DataObject asynchronously and executes the given callback block.
...
/**
 Fetches the DataObject asynchronously and executes the given callback block.
...
/**
 Deletes the DataObject asynchronously and executes the given callback block.
